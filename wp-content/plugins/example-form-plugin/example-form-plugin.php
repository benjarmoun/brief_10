...
function form_insert_data() {
  ...
  $form_rating = (isset($_POST['inlineRadioOptions']))?$_POST['inlineRadioOptions']:0;
  $form_email = (isset($_POST['your_email']))?$_POST['your_email']:'';
  $form_comment = (isset($_POST['your_comment']))?$_POST['your_comment']:'';
  $id =get_the_id(); 
